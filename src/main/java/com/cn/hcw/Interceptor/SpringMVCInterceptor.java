...
public class SpringMVCInterceptor implements HandlerInterceptor{
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        System.out.println("==============执行顺序: 1、preHandle================该方法在Controller处理之前进行被调用，,url="+url);
        return true;
    }
    ...
    public void postHandle(HttpServletRequest request,
        ...
        // TODO Auto-generated method stub
        System.out.println("==============执行顺序: 2、postHandle================在Controller的方法调用之后执行，但是它会在DispatcherServlet进行视图的渲染之前执行");
    }
    ...
    public void afterCompletion(HttpServletRequest request,
            ...
            throws Exception {
        // TODO Auto-generated method stub
        System.out.println("==============执行顺序: 3、afterCompletion================该方法将在整个请求完成之后，也就是DispatcherServlet渲染了视图执行");
    }
}
